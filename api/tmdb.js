// api/tmdb.js - V16 (Stable & Verified)
...
export default async function handler(request) {
    ...
    try {
        ...
        if (id) {
            ...
            // Default to popular movies or tv shows
            apiUrl = `https://api.themoviedb.org/3/${media_type || 'movie'}/popular?api_key=${tmdbApiKey}&language=en-US&page=1`;
        }
