...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (searchIcon) {
        searchIcon.addEventListener('click', (e) => {
            ...
            // If the search bar is already open and has text, execute search
            if (searchContainer.classList.contains('active') && searchInput.value.trim() !== '') {
                ...
                // Otherwise, just toggle the search bar's visibility
    ...
    // Add a listener to the whole document to close the search bar if a click happens outside of it
